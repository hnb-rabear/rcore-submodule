...
namespace RCore.Data.KeyValueDB
{
    ...
    public class InventoryItem : IInventoryItem
    {
        ...
        [JsonIgnore] public int BaseId { get => b; set => b = value; }
        [JsonIgnore] public int Rarity { get => r; set => r = value; }
        [JsonIgnore] public int Level { get => l; set => l = value; }
        [JsonIgnore] public int Quantity { get => q; set => q = value; }
